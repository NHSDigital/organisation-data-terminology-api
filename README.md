# organisation-data-terminology-api

![Build](https://github.com/NHSDigital/organisation-data-terminology-api/workflows/Build/badge.svg?branch=master)

This is a specification for the *organisation-data-terminology-api* API.

* `specification/` This [Open API Specification](https://digital.nhs.uk/developer/api-catalogue/organisation-data-terminology) describes the endpoints, methods and messages exchanged by the API. Use it to generate interactive documentation; the contract between the API and its consumers.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/organisation-data-terminology-api/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/organisation-data-terminology-api/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `organisation-data-terminology-api-target`.
